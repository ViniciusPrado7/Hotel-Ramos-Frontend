...
import { ContainerExplore, ExploreImg, ExploreImgCafe, ExploreImgs, ExploreImgTxt, ExploreTxt } from '../styles/ExploreStyles'

function Explore() {
    return (
        <ContainerExplore>
            <ExploreImgTxt> {/* Container img com txt row */}
                <ExploreImgCafe src="/assets/almoço-frutos-do-mar 1.png" alt="Imagem almoço frutos do mar" />
